...
# finding all folders ind dirpaths and sorting them from oldest to newest
...
ax.set_title(r'LD teplota: pokojová (302,75±0,50 K)')
...
if save:
    ...
    plt.savefig(dirpath+ "map - "+'LD teplota - pokojová (cca 301 K)' + ".png",dpi=300)
else:
    plt.show()
